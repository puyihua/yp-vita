...
\emph{Master of Science, \href{http://www.marquette.edu/engineering/mechanical/}{Mechanical Engineering}} \hfill 2012–2014
\begin{itemize*}
  \item Cumulative GPA: 3.60/4.00; Specialization: \href{http://www.marquette.edu/engineering/mechanical/grad_study.shtml}{Energy Systems}
...
\emph{Bachelor of Science, \href{http://www.msoe.edu/community/academics/mechanical-engineering-department/mechanical-engineering}{Mechanical Engineering}} \hfill 2008–2012
\begin{itemize*}
...
Paper to be presented at 2014 Purdue Compressor Conferences and Short Courses, West Lafayette, IN.

\bigskip
\mhead{Invited Talks}%
\textbf{Gessler, P.D.} (11 Nov.~2013).
...
\medskip
\textbf{Gessler, P.D.} (30 Sept.~2013).
\emph{An Introduction to Model-Based Design: With Transportation Examples.}
...
\begin{itemize*}
  ...
  \item Planned and led automated regression testing of controls performance and 210 safety events
  \item Improved automated testing speed in Excel/\MLS{} (simulation and emulation) by 15\%
  \item Created and distributed release notes documenting new features, enhancements, and known issues
  \item Extended numerical chiller models to include two more vessel configurations and enhanced stall 
...
\begin{itemize*}
  ...
  \item Coordinated with professionals and students in nearby SAE Chapters to organize monthly events
...
\begin{itemize*}
  ...
  \item Co-authored and edited the \href{https://dl.dropbox.com/u/10724484/resume/MSOE_CarbonairDesignReport2011.pdf}{Design Report}
    (awarded First Place, Design Report Competition)
\end{itemize*}
...
\begin{itemize*}
  ...
  \item Planned and promoted events for residents, such as r\'{e}sum\'{e} workshops and indoor rock climbing
  \item Enforced MSOE Residence Life policies, resolving roommate conflicts and violations as needed
\end{itemize*}
